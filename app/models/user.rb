class User < ApplicationRecord
  ...
  validates :sending_kana_for_first_name, presence: true, format: { with: /\A[ぁ-んァ-ヶ一-龥々ー]+\z/, message: "は全角カタカナで入力してください" }
  validates :sending_kana_for_last_name, presence: true, format: { with: /\A[ぁ-んァ-ヶ一-龥々ー]+\z/, message: "は全角カタカナで入力してください" }
